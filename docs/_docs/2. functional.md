...
<script>
    ...
    const requiredTestData = filteredRows.sort((r1, r2) => r1[1].requiredPassPct - r2[1].requiredPassPct);
    const optionalTestData = filteredRows.sort((r1, r2) => r1[1].optionalPassPct - r2[1].optionalPassPct);
